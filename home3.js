    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "priority": 1,
                "vtp_instanceDestinationId": "UA-211282141-1",
                "tag_id": 9
            }, {
                "function": "__rep",
                "vtp_containerId": "UA-211282141-1",
                "vtp_remoteConfig": ["map"],
                "tag_id": 1
            }, {
                "function": "__zone",
                "vtp_childContainers": ["list", ["map", "publicId", "G-PVLPHJCNCX"]],
        ...
        "blob": {
            ...
            "14": "6241",
            "15": "0",
            "16": "ChEIgOKbzAYQ6aO/gdGii7vYARIfAABC3EPB0a79EDz2Xaap10Xd39JjdouN0CwprzniGBoCeU0=",
            "17": "",
            "19": "dataLayer",
            "20": "",
        ...
        ,
        "security_groups": {
            "google": ["__ccd_ga_first", "__ccd_ga_last", "__e", "__ogt_1p_data_v2", "__rep"
            ]
...
*/
    ...
    k.isActive = function(a, b) {
        ...
        if (!c)
            return !0;
        if (!this.isActive([c.Rj], b))
            return !1;
        for (var e = 0; e < c.Og.length; e++)
            if (this.J[c.Og[e]].Se(b))
                return !0;
        return !1
    }
    ;
    ...
    OE.prototype.T = function(a, b) {
        ...
        a <= c.eventId || c.Se !== b && this.D.push({
            eventId: a,
            Se: b
        })
    }
    ...
    ;var $J = function(a, b) {
                            ...
                            if (c) {
                                ...
                                if (y && z) {
                                    ...
                                    for (var G = {
                                        ...
                                        var P = x[K];
                                        UJ[P.id] || (P && P.prefix === "AW" && !G.adData && P.ids.length >= 2 ? (G.adData = {
                                            ak: P.ids[Ko[0]],
                                            cl: P.ids[Ko[1]]
                                        },
                                        VJ(G.adData, C),
                                        UJ[P.id] = !0) : P && P.prefix === "UA" && !G.gaData && (G.gaData = {
                                            gaWpid: P.destinationId
                                        },
                                        UJ[P.id] = !0))
                                    }
                                    (G.gaData || G.adData) && WJ(XJ, E, void 0, C)(E.Ud, G, E.options)
                                }
                                ...
                                if (ea) {
                                    ...
                                    var qa = WJ(ZJ, pa, U)
                                      , Fa = {};
                                    pa.Ud !== void 0 ? Fa.receiver = pa.Ud : Fa.replace = ea;
                                    Fa.ga_wpid = U;
                                    Fa.destination = ea;
                                    qa(2, Sb(), Fa)
                                }
      ...
      , WJ = function(a, b, c, d) {
        ...
        }, Az("https://", "http://", a.scriptUrl), b.Mn, b.gu);
        return f
    }
      , aK = function() {
        function a() {
      ...
      , XJ = {
        ...
        scriptUrl: "www.gstatic.com/call-tracking/call-tracking_" + (bK.qo || bK.kq) + ".js"
    }
      , UJ = {};
    var gK = {};
    function iK(a) {
    ...
    ;var vM = function(a, b) {
        if (!b.isGtmEvent) {
            ...
            if (e === void 0) {
                var f = void 0;
                sM.hasOwnProperty(c) ? f = sM[c] : tM.hasOwnProperty(c) && (f = tM[c]);
                f === 1 && (f = uM(c));
                Fb(f) ? $z()(function() {
                    var g, h, l, n = (l = (g = $z()) == null ? void 0 : (h = g.getByName) == null ? void 0 : h.call(g, a)) == null ? void 0 : l.get(f);
                    d(n)
                }) : d(void 0)
            } else
                d(e)
      ...
      , AM = function(a, b, c) {
        if (!c.isGtmEvent || !xM[a]) {
            var d = !mo(J.m.la)
              , e = function(f) {
                var g = "gtm" + String(Co()), h, l = $z(), n = yM(b, "", c), p, q = n.createOnlyFields._useUp;
                if (c.isGtmEvent || zM(b, n.createOnlyFields)) {
                    c.isGtmEvent && (h = n.createOnlyFields,
                    n.gtmTrackerName && (h.name = g));
                    l(function() {
                        var t, u = l == null ? void 0 : (t = l.getByName) == null ? void 0 : t.call(l, b);
                        u && (p = u.get("clientId"));
                        if (!c.isGtmEvent) {
                            var v;
                    ...
                    d && mo(J.m.la) && (d = !1,
                    l(function() {
                        var t, u, v = (t = $z()) == null ? void 0 : (u = t.getByName) == null ? void 0 : u.call(t, c.isGtmEvent ? g : b);
                        !v || v.get("clientId") == p && q || (c.isGtmEvent ? (n.fieldsToSet["&gcu"] = "1",
                        n.fieldsToSet["&sst.gcut"] = Bn[f]) : (n.fieldsToSend["&gcu"] = "1",
      ...
      , KM = function(a, b, c) {
        ...
        function e(S) {
            function ma(qa, Fa) {
                for (var Va = 0; Fa && Va < Fa.length; Va++)
                    d(qa, Fa[Va])
            }
            var ka = c.isGtmEvent
              , V = ka ? CM(y) : DM(b, c);
            if (V) {
                ...
                ea !== "promo_view" && ea !== "impressions" && (ma("ec:addProduct", V.Xd),
                d("ec:setAction", ea, V.Zb))
            }
        }
        function f(S) {
            if (S) {
        ...
        function h() {
            ...
            u(function() {
                if (!c.isGtmEvent && Id(S)) {
                    var ma = y.fieldsToSend, ka, V, U = (ka = v()) == null ? void 0 : (V = ka.getByName) == null ? void 0 : V.call(ka, x), ea;
                    for (ea in S)
        ...
        if (!(q && r && r.indexOf(q.destinationId) < 0)) {
            el && (Wm = !0,
            b === J.m.na ? bn(c, a) : (c.eventMetadata[R.C.Fc] || (Zm[a] = !0),
            tB(c.eventMetadata[R.C.Ta])));
            var t, u = c.isGtmEvent ? cA(M(c, "gaFunctionName")) : cA();
            if (Eb(u)) {
                var v = $z, x;
                x = c.isGtmEvent ? M(c, "name") || M(c, "gtmTrackerName") : "gtag_" + p.split("-").join("_");
                var y = yM(x, b, c);
                !c.isGtmEvent && zM(x, y.createOnlyFields) && (u(function() {
                    var S, ma;
                    v() && ((S = v()) == null || (ma = S.remove) == null || ma.call(S, x))
                }),
                HM[x] = !1);
                u("create", p, y.createOnlyFields);
                var z = c.isGtmEvent && y.fieldsToSet[J.m.Ub];
                if (!c.isGtmEvent && y.createOnlyFields[J.m.Ub] || z) {
                    var C = Xj(c.isGtmEvent ? y.fieldsToSet[J.m.Ub] : y.createOnlyFields[J.m.Ub], "/analytics.js");
                    C && (t = C)
                }
                var E = c.isGtmEvent ? y.fieldsToSet[J.m.Ub] : y.createOnlyFields[J.m.Ub];
                if (E) {
                    var G = c.isGtmEvent ? y.fieldsToSet[J.m.Df] : y.createOnlyFields[J.m.Df];
                    G && !HM[x] && (HM[x] = !0,
                    u(eA(x, G)))
                }
                c.isGtmEvent ? y.enableRecaptcha && d("require", "recaptcha", "recaptcha.js") : (h(),
                f(y.linkAttribution));
                var K = y[J.m.fb];
                K && K[J.m.xa] && wM(K, x);
                d("set", y.fieldsToSet);
                ...
                if (b === J.m.rc)
                    if (c.isGtmEvent) {
                        ...
                        g(),
                        d("send", "pageview", y.fieldsToSend);
                else
                    b === J.m.na ? (g(),
                    $J(p, c),
                    M(c, J.m.Kb) && (Hu(["aw", "dc"]),
                    ...
                    AM(p, x, c)) : b === J.m.Gb ? vM(x, c) : b === "screen_view" ? d("send", "screenview", y.fieldsToSend) : b === "timing_complete" ? (y.fieldsToSend.hitType = "timing",
                    l("timingCategory", y.eventCategory, !0),
                    c.isGtmEvent ? l("timingVar", y.timingVar, !0) : l("timingVar", y.name, !0),
                    l("timingValue", Ob(y.value)),
                    y.eventLabel !== void 0 && l("timingLabel", y.eventLabel, !0),
                    d("send", y.fieldsToSend)) : b === "exception" ? d("send", "exception", y.fieldsToSend) : b === "" && c.isGtmEvent || (b === "track_social" && c.isGtmEvent ? (y.fieldsToSend.hitType = "social",
                    l("socialNetwork", y.socialNetwork, !0),
                    l("socialAction", y.socialAction, !0),
                    l("socialTarget", y.socialTarget, !0)) : ((c.isGtmEvent || IM[b]) && e(E),
                    c.isGtmEvent && n(),
                    y.fieldsToSend.hitType = "event",
                    l("eventCategory", y.eventCategory, !0),
                    l("eventAction", y.eventAction || b, !0),
                    y.eventLabel !== void 0 && l("eventLabel", y.eventLabel, !0),
                ...
                if (!JM && (!c.isGtmEvent || ca)) {
                    ...
                    cd(t || "https://www.google-analytics.com/analytics.js", function() {
                        var S;
      ...
      , DM = function(a, b) {
        ...
        for (var d = function(u) {
            return M(b, u)
        }, e = d(J.m.wa), f, g = 0; e && g < e.length && !(f = e[g][J.m.oi] || e[g][J.m.Af]); g++)
            ;
        var h = d(J.m.ue);
        if (Id(h))
            for (var l = 0; e && l < e.length; ++l) {
                var n = e[l], p;
                for (p in h)
                    h.hasOwnProperty(p) && /^(dimension|metric)\d+$/.test(p) && h[p] != null && GM(n, p, n[h[p]])
            }
        var q = null
          , r = d(J.m.ep);
        if (a === J.m.Fb || a === J.m.me)
            q = {
                action: a,
                Zb: c(),
                Xd: NM(e)
            ...
            q = {
                action: "click",
                Zb: {
                    list: d(J.m.oi) || d(J.m.Af) || f
                },
                Xd: NM(e)
            };
        else if (a === J.m.jd || a === "checkout_progress") {
            var t = {
                step: a === J.m.jd ? 1 : d(J.m.ni),
                option: d(J.m.ih)
            };
            q = {
                action: "checkout",
      ...
      , yM = function(a, b, c) {
        ...
        for (var r = !c.isGtmEvent, t = tp(c), u = 0; u < t.length; ++u) {
            ...
            if (c.isGtmEvent) {
                var x = d(v);
                RM.hasOwnProperty(v) ? e[v] = x : SM.hasOwnProperty(v) ? h[v] = x : g[v] = x
            } else {
                var y = void 0;
                v !== J.m.Ha ? y = d(v) : y = c.getMergedValues(v);
                if (TM.hasOwnProperty(v))
                    FM(TM[v], v, y, e);
                else if (UM.hasOwnProperty(v))
                    FM(UM[v], v, y, g);
                else if (tM.hasOwnProperty(v))
                    FM(tM[v], v, y, f);
                else if (sM.hasOwnProperty(v))
                    FM(sM[v], v, y, h);
                    ...
                    var C = void 0
                      , E = void 0;
                    b === J.m.na ? C = ec(c.getMergedValues(v), ".") : (C = ec(c.getMergedValues(v, 1), "."),
                    E = ec(c.getMergedValues(v, 2), "."));
                    C && (f["&gdid"] = C);
                    E && (f["&edid"] = E)
                } else
                    v === J.m.eb && t.indexOf(J.m.nd) < 0 && (h.cookieName = String(y) + "_ga");
                VM[v] && (c.J.hasOwnProperty(v) || b === J.m.na && c.D.hasOwnProperty(v)) && (r = !1)
            }
        }
        r && (f["&jsscut"] = "1");
        d(J.m.Yg) !== !1 && d(J.m.uc) !== !1 && xJ() || (g.allowAdFeatures = !1);
        ...
        if (c.isGtmEvent) {
            ...
            b === "login" || b === "sign_up" || b === "share" ? GM(e, "eventLabel", d(J.m.vl)) : b === "search" || b === "view_search_results" ? GM(e, "eventLabel", d(J.m.Cp)) : b === "select_content" && GM(e, "eventLabel", d(J.m.ap));
            var K = e[J.m.fb] || {}
              , P = K[J.m.Kf];
            P || P != 0 && K[J.m.xa] ? h.allowLinker = !0 : P === !1 && GM(h, "useAmpClientId", !1);
            f.hitCallback = c.onSuccess;
            h.name = a
        }
        qr() && (g["&gcs"] = rr());
        g["&gcd"] = vr(c);
        nm() && (mo(J.m.la) || (h.storage = "none"),
        mo([J.m.X, J.m.Z]) || (g.allowAdFeatures = !1,
        h.storeGac = !1));
        yr() && (g["&dma_cps"] = wr());
        g["&dma"] = xr();
        Uq(br()) && (g["&tcfd"] = zr());
      ...
      , WM = function(a) {
        var b = "general";
        YM[a] ? b = "ecommerce" : ZM[a] ? b = "engagement" : a === "exception" && (b = "error");
        return b
    }
      , uM = function(a) {
        return a && Fb(a) ? a.replace(/(_[a-z])/g, function(b) {
    ...
    eN)
      ...
      , OM = ["item_category", "item_category2", "item_category3", "item_category4", "item_category5"]
      , fN = {}
      , EM = (fN.levels = 1,
    fN[J.m.Ab] = "duration",
    fN[J.m.nd] = 1,
        ...
        var a = {}
          ...
          , c = function(d) {
            ...
            if (d.vtp_gtmTagId in a)
                JE(a[d.vtp_gtmTagId], d.vtp_gtmEventId, e);
            else if (e) {
                var f = d.vtp_childContainers.map(function(l) {
                    return l.publicId
                })
                  , g = d.vtp_enableTypeRestrictions ? d.vtp_whitelistedTypes.map(function(l) {
                    return l.typeId
                }) : null
                  , h = LE(d.vtp_gtmEventId, f, g, Qz(1, d.vtp_gtmEntityIndex, d.vtp_gtmEntityName), !!d.vtp_inheritParentConfig);
                a[d.vtp_gtmTagId] = h
            }
            jd(d.vtp_gtmOnSuccess)
        };
        Z.__zone = c;
        Z.__zone.H = "zone";
